		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee List",
									"targetURL": "#comsbpemployeelist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsbpemployeelist-display": {
								"semanticObject": "comsbpemployeelist",
								"action": "display",
								"description": "An Employee List Application",
								"title": "Employee List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sbp.employeelist",
									"url": sap.ui.require.toUrl("com/sbp/employeelist")
								}
							}
						}
					}
