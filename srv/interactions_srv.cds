...
service CatalogService {
   ...
   entity Employees           as projection on interactions.Employee;
   entity Orders              as projection on interactions.Order;
   entity Employeeorders      as projection on interactions.Employeeorders;
